...
function Operations() {
  ...
  const getApiUrl = () => {
    if (location === "inhouse" && category === "WBSEDCL")
      return "http://192.168.0.106:5050/api/operations/inhousewb";

    if (location === "inhouse" && category === "private")
      return "http://192.168.0.106:5050/api/operations/inhousepvt";

    if (location === "inhouse" && category === "public")
      return "http://192.168.0.106:5050/api/operations/inhousepub";

    if (location === "site" && category === "WBSEDCL")
      return "http://192.168.0.106:5050/api/operations/sitewb";
    if (location === "site" && category === "private")
      return "http://192.168.0.106:5050/api/operations/sitepvt";
    if (location === "site" && category === "public")
      return "http://192.168.0.106:5050/api/operations/sitepub";
